using PuertaDeEntrada.Domain.Common;
using Microsoft.Extensions.Configuration;
using System;
using System.IO;

namespace PuertaDeEntrada.Application.Common.Utils
{
    public static class VariablesUtil
    {
        public static string GetConnectionString(IConfiguration configuration)
        {
            ...
            connection.Connection = $"Server={connection.Server},{connection.Port};Database={connection.Database};User Id={connection.UserId};Password={connection.Password}";
